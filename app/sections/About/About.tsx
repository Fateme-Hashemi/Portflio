  ...
  return (
    <SectionWrapper id="about" className=" " sectionName="About">
      ...
      >
        ...
        <p className="">
  I&apos;m Fatemeh Hashemi, a Front-End Developer with over three years of experience in creating visually appealing, responsive, and interactive web pages. My expertise lies in crafting dynamic user interfaces using technologies like HTML, CSS, JavaScript. I am passionate about building seamless and engaging user experiences, focusing on performance and accessibility.
</p>
